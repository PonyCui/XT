...
class XTUIViewAnimator {

    companion object {

        var animationEnabled = false
        var animationProps: Map<String, XTUIViewAnimationProperty<Any>> = mapOf()
        var animatingHandlers: Map<String, () -> Unit> = mapOf()

        fun addAnimation(aniProp: XTUIViewAnimationProperty<Any>) {
        ...
        fun animationWithDuration(duration: Double, animations: () -> Unit, completion: () -> Unit) {
            ...
            XTUIViewAnimator.animatingHandlers?.let {
                val mutable = it.toMutableMap()
                mutable.putAll(animatingHandlers)
                XTUIViewAnimator.animatingHandlers = mutable.toMap()
            }
        ...
        fun animationWithBouncinessAndSpeed(bounciness: Double, speed: Double, animations: () -> Unit, completion: () -> Unit) {
            ...
            animationProps = mapOf()
            XTUIViewAnimator.animatingHandlers = animatingHandlers.toMap()
        }
