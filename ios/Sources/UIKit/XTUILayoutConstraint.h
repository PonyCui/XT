...
@class XTUILayoutConstraint;

@protocol XTUILayoutConstraintExport <JSExport>
...
@interface XTUILayoutConstraint : NSObject<XTComponent, XTUILayoutConstraintExport>
