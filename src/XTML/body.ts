        ...
        for (let index = 0; index < layoutElements.length; index++) {
            ...
            for (let index = 0; index < layoutElement.children.length; index++) {
                ...
                if (element.tagName === "FULLWIDTH" && element.getAttribute("view")) {
                    ...
                    (function(view){
                        if (!view) {return}
                        view.superview.addConstraints(XT.LayoutConstraint.constraintsWithVisualFormat("|-` + parseFloat(element.getAttribute("value") || "0").toFixed(6) + `-[view]", {view: view}));
                        view.superview.setNeedsLayout();
                    })(rootElement['`+ element.getAttribute("view") + `']);
                    `)
                }
                    ...
                    (function(view){
                        if (!view) {return}
                        view.superview.addConstraints(XT.LayoutConstraint.constraintsWithVisualFormat("[view]-` + parseFloat(element.getAttribute("value") || "0").toFixed(6) + `-|", {view: view}));
                        view.superview.setNeedsLayout();
                    })(rootElement['`+ element.getAttribute("view") + `']);
                    `)
                }
                    ...
                    (function(view){
                        if (!view) {return}
                        view.superview.addConstraints(XT.LayoutConstraint.constraintsWithVisualFormat("V:|-` + parseFloat(element.getAttribute("value") || "0").toFixed(6) + `-[view]", {view: view}));
                        view.superview.setNeedsLayout();
                    })(rootElement['`+ element.getAttribute("view") + `']);
                    `)
                }
                    ...
                    (function(view){
                        if (!view) {return}
                        view.superview.addConstraints(XT.LayoutConstraint.constraintsWithVisualFormat("V:[view]-` + parseFloat(element.getAttribute("value") || "0").toFixed(6) + `-|", {view: view}));
                        view.superview.setNeedsLayout();
                    })(rootElement['`+ element.getAttribute("view") + `']);
                    `)
                }
