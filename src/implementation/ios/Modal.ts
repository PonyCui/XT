...
export class Alert {
    ...
    show(callback?: () => void): void {
        _XTUIModal.showAlertCallback({ message: this.message, buttonTitle: this.buttonTitle }, callback)
    }
...
export class Confirm {
    ...
    show(resolve: () => void, reject: () => void): void {
        _XTUIModal.showConfirmResolverRejected({
...
export class Prompt {
    ...
    show(resolve: (value: string) => void, reject: () => void): void {
        _XTUIModal.showPromptResolverRejected({
            message: this.message,
            confirmTitle: this.confirmTitle,
            cancelTitle: this.cancelTitle,
